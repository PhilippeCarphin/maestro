...
SharedData_setMiscData BG_TEMPLATES_DIR $env(SEQ_PACKAGE_HOME)/src/xflow/etc/bg_templates
...
proc ExpModTreeControl_readAppConfig {} {
   ...
   set configFile  $env(SEQ_PACKAGE_HOME)/src/xflow/etc/config/xm.cfg
