...
proc Dialogs::setDlg {} {
	 ...
	 variable Bug_title 
         ...
         variable All_experience
		  ...
		  set Dlg_ErrorParseConfigOP "Please ask CMOI to check the syntax in file \$SEQ_SRC/xm/etc/config/Operational_Exp.cfg"
		  ...
		  set Dlg_ErrorParseConfigOP "SVP demander a CMOI de verifier la syntaxe du fichier \$SEQ_SRC/xm/etc/config/Operational_Exp.cfg"
