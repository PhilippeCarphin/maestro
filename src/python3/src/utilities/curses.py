...
def get_curses_attr_from_color(curses_color_index,
                               logger=None,
                               is_reversed=True):
    try:
