...
#define for_tokens(token, string, delimiters, sp)                              \
  ...
  for (token = strtok_r(tmpString, delimiters, &sp); token != NULL;            \
...
int genFileList(LISTNODEPTR *fileList, const char *directory,
                LISTNODEPTR *filterList);
...
int WriteNodeWaitedFile_nfs(const char *, const char *, const char *,
                            const char *, const char *, const char *);
int WriteInterUserDepFile_nfs(const char *, const char *, const char *,
                              const char *, const char *, const char *);
int WriteForEachFile_nfs(const char *, const char *, const char *, const char *,
                         const char *, const char *);
int WriteInterUserForEachFile_nfs(const char *, const char *, const char *,
                                  const char *, const char *, const char *);
...
char *SeqUtil_relativePathEvaluation(char *depName,
                                     SeqNodeDataPtr _nodeDataPtr);
void SeqUtil_printOrWrite(FILE *filename, char *text, ...);
int SeqUtil_basicTruncatedAverage(int *unsorted_int_array, int elements,
