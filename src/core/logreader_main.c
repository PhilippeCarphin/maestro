/* logreader_main.c - Command-line API for the logreader and statistics tool
...
static void printUsage() {
  char *usage = "For complete and up to date information on this command, see "
                "the man page by typing 'man logreader'.";
  puts(usage);
}

int main(int argc, char *argv[]) {
  char *type = NULL, *inputFile = NULL, *outputFile = NULL, *exp = NULL,
       *datestamp = NULL, *tmpDate = NULL, *tmpExp = NULL;
  ...
  logreader(inputFile, outputFile, exp, datestamp, read_type, stats_days,
            clobberFile);
