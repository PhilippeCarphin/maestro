...
rm -f ssm/*
mkdir -p ssm
tar -zcvf ssm/maestro_1.5.1_${package}.ssm -C build ${folder}/bin ${folder}/src/core ${folder}/src/utilities ${folder}/src/xflow ${folder}/src/xm ${folder}/src/tcl ${folder}/.ssm.d
