...
echo "These roff files were generated by the script '$SCRIPT_NAME' from the maestro project. You probably shouldn't modify them - instead modify the markdown files they were generated from." >> $TARGET_FOLDER/README
